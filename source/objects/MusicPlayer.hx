...
class MusicPlayer extends FlxGroup 
{
	...
	public function new(instance:FreeplayState)
	{
		...
		songTxt.setFormat(Paths.font("vcr"), 32, FlxColor.WHITE, RIGHT);
		add(songTxt);

		timeTxt = new FlxText(xPos, songTxt.y + 60, 0, "", 32);
		timeTxt.setFormat(Paths.font("vcr"), 32, FlxColor.WHITE, RIGHT);
		add(timeTxt);
		...
		playbackTxt.setFormat(Paths.font("vcr"), 32, FlxColor.WHITE);
		add(playbackTxt);
