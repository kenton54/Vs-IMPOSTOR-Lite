...
class PauseSubState extends MusicBeatSubstate
{
	...
	override function create()
	{
		...
		var bar:FlxSprite = new FlxSprite().loadGraphic(Paths.image('ingame/pause'));
		bar.updateHitbox();
		...
		levelInfo.setFormat(Paths.font("dogicapixel.ttf"), 32);
		levelInfo.updateHitbox();
		add(levelInfo);

		var blueballedTxt:FlxText = new FlxText(20, 15 + 34, 0, "Lost: " + PlayState.deathCounter, 32);
		blueballedTxt.scrollFactor.set();
		blueballedTxt.setFormat(Paths.font('dogicapixel.ttf'), 32);
		blueballedTxt.updateHitbox();
		add(blueballedTxt);

		practiceText = new FlxText(20, 15 + 101, 0, "PRACTICE MODE", 32);
		practiceText.scrollFactor.set();
		practiceText.setFormat(Paths.font('dogicapixel.ttf'), 32);
		...
		chartingText.setFormat(Paths.font('dogicapixel.ttf'), 32);
		...
		missingText.setFormat(Paths.font("dogicapixel.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
